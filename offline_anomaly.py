...
packet_features = deque(maxlen=300)
packet_lengths = deque(maxlen=300)
packet_indices = deque(maxlen=300)
...
def extract_features(pkt):
    ...
    try:
        ...
        proto = hash(pkt.highest_layer) % 1000
...
try:
    for idx, pkt in enumerate(capture.sniff_continuously(packet_count=0)):
